...
%                             mean(mean_mean_plv((time_dec>=reference_window(1))&(time_dec<=reference_window(2))));
                       ...
                       these_delta_PLV_odor_minus_ref_per_mouse=[];
                        for mouse_ii=1:length(these_mouse_nos)
                            ...
                            these_delta_PLV_odor_minus_ref_per_mouse(mouse_ii)=delta_PLV_odor_minus_ref_per_mouse(these_mouse_nos(mouse_ii),bw_ii,per_ii,eventNo_ii);
                            group_no_per_mouse(these_mouse_nos(mouse_ii))=grNo;
                        end
                    ...
                    for eventNo_ii=length(handles.drgbchoices.evTypeNos):-1:1
                       ...
                       %Get the PLVs
                        ...
                        for mouse_ii=1:length(these_mouse_nos)
                            ...
                            delta_phase_odor_per_mouse(these_mouse_nos(mouse_ii),bw_ii,per_ii,eventNo_ii)=circ_mean(this_mean_dp((time_dec>=odor_window(1))&(time_dec<=odor_window(2)),1));
                        end
...
save([PLVBatchPathName PLVFileName(1:end-4) '_out.mat'],'delta_PLV_odor_minus_ref','delta_phase_odor','drgbchoices','delta_PLV_odor_minus_ref_per_mouse'...
    ,'delta_phase_odor_per_mouse','group_no_per_mouse'); 
