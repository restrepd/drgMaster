function handles_out=drgOBDREADDS_PRP(handles_choices)
%drgOBChr2LFPpower 
...
%     electrode_label='Right CA1';
    ...
    handles.burstLowF=65;       %burst is the power bandwidth (e.g. 65-95 Hz is high gamma)
...
for fileNo=1:length(jtFileNames)
    ...
    [t_apt,freq,all_Power, all_Power_ref, all_Power_timecourse, this_trialNo, perCorr_pertr, which_event, is_not_moving]=drgGetLFPwavePowerForThisEvTypeNo(handles);
