    ...
    for laser_or_not_ii=1:2
        ...
        for groupNo=1:max(handles_out.drgbchoices.group_no)
            ...
            for mouseNo=1:length(handles_out.discriminant_PACwavepower)
                try
                    if laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).discriminant_calculated==1
                        per_ii=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).no_trials;
                        no_mice=no_mice+1;
                        if (per_ii>=20)&(sum(no_mice==mice_excluded)==0)
                            no_mice_included=no_mice_included+1;
                            all_discriminant_correct_peak(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).discriminant_correct_peak;
                            all_discriminant_correct_trough(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).discriminant_correct_trough;
                            all_discriminant_correct_shuffled_peak(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).discriminant_correct_shuffled_peak;
                            all_discriminant_correct_shuffled_trough(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).discriminant_correct_shuffled_trough;
                            all_dimensionality_peak(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).dimensionality_peak;
                            all_dimensionality_trough(no_mice_included,:)=laser_or_not(laser_or_not_ii).discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis).PACii(PACii).dimensionality_trough;
                        end
                    end
                catch
                end
            ...
            no_mice_per(laser_or_not_ii)=no_mice_included;
            ...
            p_correct_stats(ii_stats).description=[handles_out.drgbchoices.group_no_names{groupNo}  ' ' handles_out.drgbchoices.per_lab{laser_or_not_ii} ' shuffled peak'];
            p_correct_stats(ii_stats).data_ii=1;
            p_correct_stats(ii_stats).PACii=PACii;
            p_correct_stats(ii_stats).per_corr_ii=laser_or_not_ii;
            ...
            glm_correct.perCorr(glm_ii+1:glm_ii+length(data))=laser_or_not_ii;
            ...
            ii_stats=ii_stats+1;
            p_correct_stats(ii_stats).data=data;
            p_correct_stats(ii_stats).description=[handles_out.drgbchoices.group_no_names{groupNo}  ' ' handles_out.drgbchoices.per_lab{laser_or_not_ii} ' shuffled trough'];
            ...
            ii_stats=ii_stats+1;
            p_correct_stats(ii_stats).data=data;
            p_correct_stats(ii_stats).description=[handles_out.drgbchoices.group_no_names{groupNo} ' ' handles_out.drgbchoices.per_lab{laser_or_not_ii} ' trough'];
            ...
            p_correct_stats(ii_stats).description=[handles_out.drgbchoices.group_no_names{groupNo} ' ' ...
                handles_out.drgbchoices.per_lab{laser_or_not_ii}...
                ' peak'];
            ...
            title(['LDA for theta/' handles_out.drgbchoices.PACnames{PACii} ' ' handles_out.drgbchoices.group_no_names{groupNo}  ' ' handles_out.drgbchoices.per_lab{laser_or_not_ii}])
            
            xlabel('Time (sec)')
            ylabel(['% correct '  handles_out.drgbchoices.per_lab{laser_or_not_ii}])
            ...
            title(['Area under the curve for theta/' handles_out.drgbchoices.PACnames{PACii} ' ' handles_out.drgbchoices.group_no_names{groupNo}  ' ' handles_out.drgbchoices.per_lab{laser_or_not_ii}])
