...
for pacii=[1 3]    %for amplitude bandwidths (beta, low gamma, high gamma)
    ...
    for evNo=1:2
        ...
        for per_ii=2:-1:1
            ...
            for grNo=1:3
                ...
                glm_mi.mouseNo(glm_ii+1:glm_ii+length(these_mi))=these_mouse_nos;
    ...
    [p anovanTbl stats]=anovan(glm_mi.data,{glm_mi.group,glm_mi.perCorr glm_mi.event glm_mi.mouseNo},...
        'model','interaction',...
        'nested',nesting,...
...
for pacii=[1 3]    %for amplitude bandwidths (beta, low gamma, high gamma)
    ...
    for evNo=1:2
        ...
        for per_ii=2:-1:1
            ...
            for grNo=1:3
                ...
                glm_PA.mouseNo(glm_ii+1:glm_ii+length(these_PA))=these_mouse_nos;
    ...
    [p anovanTbl stats]=anovan(glm_PA.data,{glm_PA.group,glm_PA.perCorr glm_PA.event glm_PA.mouseNo},...
        'model','interaction',...
        'nested',nesting,...
        'varnames',{'genotype','naive_vs_proficient', 'rewarded_vs_unrewarded','mouse_no'});
