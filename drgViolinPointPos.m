function [mean_points, CI_points,violin_x_val] = drgViolinPointPos(points,edges,x_val,rand_offset,which_color_mean,which_color_point,point_size,violin_x_val)
