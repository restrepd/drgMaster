function [log_P_t,no_trials_w_event,which_event,f,out_times,times,phase_per_trial,no_trials,no_events_per_trial,t_per_event_per_trial,trial_map,perCorr,no_ref_evs_per_trial]=drgLickTimecourse(handles)
...
for trNo=firstTr:lastTr
    ...
    if evNo~=-1
        ...
        if excludeTrial==0
            ...
            %Note: handles.peakLFPNo is the reference LFP
            [referenceLFP, trialNo, can_read1] = drgGetTrialLFPData(handles, lickLFPNo, evNo, handles.evTypeNo, handles.time_start+handles.time_pad, handles.time_end-handles.time_pad);
