...
for trNo=firstTr:lastTr
    ...
    if evNo~=-1
        ...
        if excludeTrial==0
            ...
            [sniff, trialNo, can_read2] = drgGetTrialLFPData(handles, 18, evNo, handles.evTypeNo, handles.time_start, handles.time_end);
            ...
            if (can_read1==1)&(can_read2==1)
                ...
                thisanglethetaLFP = angle(hilbert(thfiltLFP)); % phase modulation of theta amplitude
                anglethetaLFP = [anglethetaLFP thisanglethetaLFP];
                
                %Get sniff phase
                bpFiltsniff = designfilt('bandpassiir','FilterOrder',20, ...
                    'HalfPowerFrequency1',6,'HalfPowerFrequency2',12, ...
                    'SampleRate',Fs);
                ...
                %Delta phase
                delta_phase_timecourse(no_trials,:)=thisanglesniff-thisanglethetaLFP;
...
if handles.displayData==1
    ...
    histogram(anglesniff-anglethetaLFP,edges,'Normalization','probability')
