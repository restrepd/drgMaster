...
for pacii=[1 2]    %for amplitude bandwidths (beta, high gamma)
    ...
    for per_ii=2:-1:1
        ...
        title(['Trough zPRP pre-lick for' bandwidth_names{pacii} ' ' prof_naive_leg{per_ii} ' hippocampus'])
    ...
    nesting=[0 0 0 0 0; ... % This line indicates that naive_vs_proficient factor is not nested in any other factor.
        0 0 0 0 0; ... % This line indicates that sp_vs_sm is not nested in any other factor.
        0 0 0 0 0; ... % This line indicates that pre_vs_post is not nested in any other factor.
        0 0 0 0 0; ... % This line indicates that peak_vs_trough is not nested in any other factor.
    ...
    [p anovanTbl stats]=anovan(glm_PRP_hipp.data,{glm_PRP_hipp.perCorr glm_PRP_hipp.event glm_PRP_hipp.before_after glm_PRP_hipp.peak glm_PRP_hipp.mouse_no},...
        'model','interaction',...
        'nested',nesting,...
        'varnames',{'naive_vs_proficient', 'sp_vs_sm','pre_vs_post','peak_vs_trough','mouse_no'});
    
    fprintf(fileID, ['\n\nNested ANOVAN for zPRP during odor per mouse per odor pair for '  bandwidth_names{pacii} ' for hippocampus\n']);
...
for pacii=[1 2]    %for amplitude bandwidths (beta, high gamma)
    ...
    glm_dect_pre.data(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_data;
    glm_dect_pre.mouse_no(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_mice;
    glm_dect_pre.lick_peak_trough(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    glm_dect_pre.pre_vs_post(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    glm_dect_pre_ii=glm_dect_pre_ii+length(these_data);
    
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Lick pre-lick'];
    
    %peak
    these_data=peak_decision_times_pre_hipp(found_peak_decision_times_pre_hipp==1);
    these_mice=these_mouse_nos_peak(found_peak_decision_times_pre_hipp==1);
    glm_dect_pre.data(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_data;
    glm_dect_pre.mouse_no(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_mice;
    glm_dect_pre.lick_peak_trough(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_pre.pre_vs_post(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    glm_dect_pre_ii=glm_dect_pre_ii+length(these_data);
    
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Peak pre-lick '];
    
    %trough
    these_data=trough_decision_times_pre_hipp(found_trough_decision_times_pre_hipp==1);
    these_mice=these_mouse_nos_trough(found_trough_decision_times_pre_hipp==1);
    glm_dect_pre.data(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_data;
    glm_dect_pre.mouse_no(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_mice;
    glm_dect_pre.lick_peak_trough(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=2*ones(1,length(these_data));
    glm_dect_pre.pre_vs_post(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    glm_dect_pre_ii=glm_dect_pre_ii+length(these_data);
    
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Trough pre-lick '];
    ...
    these_data=lick_decision_times_hipp(found_lick_decision_times_hipp==1);
    these_mice=these_mouse_nos_licks(found_lick_decision_times_hipp==1);
    glm_dect_post.data(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_data;
    glm_dect_post.mouse_no(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_mice;
    glm_dect_post.lick_peak_trough(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=zeros(1,length(these_data));
    glm_dect_post.pre_vs_post(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_post_ii=glm_dect_post_ii+length(these_data);
    
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Lick post'];
    ...
    glm_dect_post.data(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_data;
    glm_dect_post.mouse_no(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_mice;
    glm_dect_post.lick_peak_trough(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_post.pre_vs_post(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_post_ii=glm_dect_post_ii+length(these_data);
    
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Peak post-lick hippocampus ' bandwidth_names{pacii}];
    ...
    glm_dect_post.data(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_data;
    glm_dect_post.mouse_no(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_mice;
    glm_dect_post.lick_peak_trough(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=2*ones(1,length(these_data));
    glm_dect_post.pre_vs_post(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_post_ii=glm_dect_post_ii+length(these_data);
    
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Trough post-lick hippocampus ' bandwidth_names{pacii}];
    ...
    %Perform the glm for divergence time pre-lick ztPRP
    fprintf(1, ['glm for divergence time per mouse per odor pair for pre-lick ztPRP for ' bandwidth_names{pacii}  ' for hippocampus\n'])
    fprintf(fileID, ['glm for divergence time per mouse per odor for pair pre-lick ztPRP for ' bandwidth_names{pacii}  ' for hippocampus\n']);
    
    tbl = table(glm_dect_pre.data',glm_dect_pre.lick_peak_trough',...
    ...
    %Do the ranksum/t-test
    fprintf(1, ['\n\nRanksum or t-test p values for detection time per mouse per odor pair for pre-lick ztPRP for ' bandwidth_names{pacii} ' for hippocampus \n'])
    fprintf(fileID, ['\n\nRanksum or t-test p values for detection time per mouse per odor pair for pre-lick ztPRP for ' bandwidth_names{pacii} ' for hippocampus \n']);
    
    
    [output_data] = drgMutiRanksumorTtest(input_dect_pre_data, fileID);
    ...
    [p anovanTbl stats]=anovan(glm_dect_pre.data,{glm_dect_pre.lick_peak_trough glm_dect_pre.mouse_no},...
        'model','interaction',...
        'nested',nesting,...
        'varnames',{'lick_peak_trough','mouse_no'});
    
    fprintf(fileID, ['\n\nNested ANOVAN for detection time per mouse per odor pair for pre-lick ztPRP for '  bandwidth_names{pacii} ' hippocampus\n'])
    drgWriteANOVANtbl(anovanTbl,fileID);
    
    
    
    %Perform the glm for divergence time post-lick ztPRP
    fprintf(1, ['glm for divergence time per mouse per odor pair for post-lick ztPRP for ' bandwidth_names{pacii} ' hippocampus\n'])
    fprintf(fileID, ['glm for divergence time per mouse per odor for pair post-lick ztPRP for ' bandwidth_names{pacii} ' hippocampus\n']);
    
    tbl = table(glm_dect_post.data',glm_dect_post.lick_peak_trough',...
        'VariableNames',{'detection_time','lick_peak_trough'});
    mdl = fitglm(tbl,'detection_time~lick_peak_trough'...
        ,'CategoricalVars',[2])
    ...
    %Do the ranksum/t-test
    fprintf(1, ['\n\nRanksum or t-test p values for detection time per mouse per odor pair for post-lick ztPRP for hippocampus '  bandwidth_names{pacii} '\n'])
    fprintf(fileID, ['\n\nRanksum or t-test p values for detection time per mouse per odor pair for post-lick ztPRP for hippocampus '  bandwidth_names{pacii} '\n']);
    
    
    [output_data] = drgMutiRanksumorTtest(input_dect_post_data, fileID);
    ...
    [p anovanTbl stats]=anovan(glm_dect_post.data,{glm_dect_post.lick_peak_trough glm_dect_post.mouse_no},...
        'model','interaction',...
        'nested',nesting,...
        'varnames',{'lick_peak_trough','mouse_no'});
    
    fprintf(fileID, ['\n\nNested ANOVAN for detection time per mouse per odor pair for post-lick ztPRP for '  bandwidth_names{pacii} ' hippocampus\n'])
    drgWriteANOVANtbl(anovanTbl,fileID);
    
    
    %
    %     %Perform the glm for divergence time per mouse
    %     fprintf(1, ['glm for divergence time per mouse for hippocampus '  bandwidth_names{pacii} '\n'])
    % %     fprintf(fileID, ['glm for divergence time per mouse for hippocampus '  bandwidth_names{pacii} '\n']);
    %
...
title(['Lick-referenced peak PRP S- ' dt_legend{ii_dt} ' '  prof_naive_leg{per_ii} ' hippocampus'])
xlabel('Time(sec)')
ylabel('p')
xlim([-0.3 0.3])
ylim([0 p_max])
...
title(['Lick-referenced trough PRP S- ' dt_legend{ii_dt} ' '  prof_naive_leg{per_ii}  ' hippocampus'])
xlabel('Time(sec)')
ylabel('p')
xlim([-0.3 0.3])
ylim([0 p_max])
...
for pacii=[1 2]    %for amplitude bandwidths (beta, high gamma)
    ...
    for per_ii=2:-1:1
        ...
        title(['Trough zPRP pre-lick for' bandwidth_names{pacii} ' ' prof_naive_leg{per_ii} ' prefrontal'])
    ...
    [p anovanTbl stats]=anovan(glm_PRP_pre.data,{glm_PRP_pre.perCorr glm_PRP_pre.event glm_PRP_pre.before_after glm_PRP_pre.peak glm_PRP_pre.mouse_no},...
        'model','interaction',...
        'nested',nesting,...
        'varnames',{'naive_vs_proficient', 'sp_vs_sm','pre_vs_post','peak_vs_trough','mouse_no'});
    
    fprintf(fileID, ['\n\nNested ANOVAN for zPRP during odor per mouse per odor pair for '  bandwidth_names{pacii} ' for prefrontal\n']);
    drgWriteANOVANtbl(anovanTbl,fileID);
    fprintf(fileID, '\n\n');
...
for pacii=[1 2]    %for amplitude bandwidths (beta, high gamma)
    ...
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Lick pre-lick ' bandwidth_names{pacii}];
    
    %peak
    these_data=peak_decision_times_pre_pref(found_peak_decision_times_pre_pref==1);
    these_mice=these_mouse_nos_peak(found_peak_decision_times_pre_pref==1);
    glm_dect_pre.data(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_data;
    glm_dect_pre.mouse_no(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_mice;
    glm_dect_pre.lick_peak_trough(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=ones(1,length(these_data));
    glm_dect_pre.pre_vs_post(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    ...
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Peak pre-lick ' bandwidth_names{pacii}];
    
    %trough
    these_data=trough_decision_times_pre_pref(found_trough_decision_times_pre_pref==1);
    these_mice=these_mouse_nos_trough(found_trough_decision_times_pre_pref==1);
    glm_dect_pre.data(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_data;
    glm_dect_pre.mouse_no(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=these_mice;
    glm_dect_pre.lick_peak_trough(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=2*ones(1,length(these_data));
    glm_dect_pre.pre_vs_post(glm_dect_pre_ii+1:glm_dect_pre_ii+length(these_data))=zeros(1,length(these_data));
    ...
    id_dect_pre_ii=id_dect_pre_ii+1;
    input_dect_pre_data(id_dect_pre_ii).data=these_data;
    input_dect_pre_data(id_dect_pre_ii).description=['Trough pre-lick ' bandwidth_names{pacii}];
    
    %Now let's plot divergence times
    figureNo = figureNo + 1;
    try
        close(figureNo)
    catch
    ...
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Lick post-lick ' bandwidth_names{pacii}];
    ...
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Peak post-lick ' bandwidth_names{pacii}];
    
    %trough
    these_data=trough_decision_times_post_pref(found_trough_decision_times_post_pref==1);
    these_mice=these_mouse_nos_peak(found_trough_decision_times_post_pref==1);
    glm_dect_post.data(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_data;
    glm_dect_post.mouse_no(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=these_mice;
    glm_dect_post.lick_peak_trough(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=2*ones(1,length(these_data));
    glm_dect_post.pre_vs_post(glm_dect_post_ii+1:glm_dect_post_ii+length(these_data))=ones(1,length(these_data));
    ...
    id_dect_post_ii=id_dect_post_ii+1;
    input_dect_post_data(id_dect_post_ii).data=these_data;
    input_dect_post_data(id_dect_post_ii).description=['Trough post-lick ' bandwidth_names{pacii}];
    ...
    %Perform the glm for divergence time
    fprintf(1, ['glm for divergence time per mouse per odor pair for pre-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n'])
    fprintf(fileID, ['glm for divergence time per mouse per odor pair for pre-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n']);
    
    tbl = table(glm_dect_pre.data',glm_dect_pre.lick_peak_trough',...
        'VariableNames',{'divergence_time','lick_peak_trough'});
    mdl = fitglm(tbl,'divergence_time~lick_peak_trough'...
        ,'CategoricalVars',[2])
    ...
    %Do the ranksum/t-test
    fprintf(1, ['\n\nRanksum or t-test p values for divergence time for pre-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n'])
    fprintf(fileID, ['\n\nRanksum or t-test p values for divergence time for pre-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n']);
    ...
    fprintf(fileID, ['\n\nNested ANOVAN for divergence time per mouse per odor pair for pre-lick ztPRP for '  bandwidth_names{pacii} ' for prefrontal\n'])
    drgWriteANOVANtbl(anovanTbl,fileID);
    
    
    %Perform the glm for divergence time
    fprintf(1, ['glm for divergence time per mouse per odor pair for post-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n'])
    fprintf(fileID, ['glm for divergence time per mouse per odor pair for post-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n']);
    ...
    %Do the ranksum/t-test
    fprintf(1, ['\n\nRanksum or t-test p values for divergence time for post-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n'])
    fprintf(fileID, ['\n\nRanksum or t-test p values for divergence time for post-lick ztPRP for prefrontal '  bandwidth_names{pacii} '\n']);
    ...
    fprintf(fileID, ['\n\nNested ANOVAN for divergence time per mouse per odor pair for post-lick ztPRP for '  bandwidth_names{pacii} ' for prefrontal\n'])
    drgWriteANOVANtbl(anovanTbl,fileID);
    
    %     %Perform the glm for divergence time per mouse
    %     fprintf(1, ['glm for divergence time per mouse for prefrontal\n'])
    % %     fprintf(fileID, ['glm for divergence time per mouse for prefrontal\n']);
    %
    %     tbl = table(glm_dect_mm.data',glm_dect_mm.lick_peak_trough',glm_dect_mm.pre_vs_post',...
    %         'VariableNames',{'divergence_time','lick_peak_trough','pre_vs_post'});
    %     mdl = fitglm(tbl,'divergence_time~lick_peak_trough+pre_vs_post+lick_peak_trough*pre_vs_post'...
    %         ,'CategoricalVars',[2,3])
    %
    %
    %     txt = evalc('mdl');
...
title(['Lick-referenced peak PRP S- ' dt_legend{ii_dt} ' '  prof_naive_leg{per_ii}  ' prefrontal'])
xlabel('Time(sec)')
ylabel('p')
xlim([-0.3 0.3])
ylim([0 p_max])
...
title(['Lick-referenced trough PRP S- ' dt_legend{ii_dt} ' '  prof_naive_leg{per_ii} ' prefrontal'])
xlabel('Time(sec)')
ylabel('p')
xlim([-0.3 0.3])
ylim([0 p_max])
