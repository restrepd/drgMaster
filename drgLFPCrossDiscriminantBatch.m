function drgLFPCrossDiscriminantBatch
            ...
            if process_data_for_mouse==1
                ...
                for filNum=first_file:no_files
                    if (handles.drgbchoices.mouse_no(filNum)==mouseNo)&(handles.drgbchoices.group_no(filNum)==groupNo)
                        ...
                        no_elect=length(handles.drgbchoices.phase_electrodes);
                        ...
                        if (sum(handles.drgbchoices.which_discriminant==4)>0)||(sum(handles.drgbchoices.which_discriminant==5)>0)...
                                ...
                                ||(sum(handles.drgbchoices.which_discriminant==13)>0)
                            for LFPNo=1:no_elect
...
%                                                      for LFPNo=1:no_elect
                            ...
                            if (sum(handlespf.drgbchoices.which_discriminant==1)>0)||(sum(handlespf.drgbchoices.which_discriminant==2)>0)...
                                ...
                                this_peakLFPNo=handlespf.drgbchoices.phase_electrodes(LFPNo);
                                handlespf.peakLFPNo=this_peakLFPNo;
                                this_burstLFPNo=handlespf.drgbchoices.wavelet_electrodes(LFPNo);
                                handlespf.burstLFPNo=this_burstLFPNo;
...
%                                         par_out(LFPNo).PACwave(PACii).meanPower=meanPowerwave;
                        ...
                        if (sum(handles.drgbchoices.which_discriminant==1)>0)||(sum(handles.drgbchoices.which_discriminant==2)>0)...
                                ||(sum(handles.drgbchoices.which_discriminant==3)>0)||(sum(handles.drgbchoices.which_discriminant==6)>0)
                            t=par_out(1).t;
                            for LFPNo=1:length(handles.drgbchoices.phase_electrodes)
                                ...
                                if LFPNo==1
                                    if no_trials==0
                                        all_log_P_timecourse=zeros(length(handles.drgbchoices.lowF),length(handles.drgbchoices.phase_electrodes),par_out(LFPNo).length_trial_no,length(t));
                                    else
                                        this_all_log_P_timecourse=[];
                                        this_all_log_P_timecourse=all_log_P_timecourse;
                                        szt=size(this_all_log_P_timecourse,4);
                                        all_log_P_timecourse=zeros(length(handles.drgbchoices.lowF),length(handles.drgbchoices.phase_electrodes),par_out(LFPNo).length_trial_no+no_trials,length(t));
                            ...
                            for LFPNo=1:length(handles.drgbchoices.phase_electrodes)
                                ...
                                if LFPNo==1
                                    if no_trialsPAC==0
                                        ...
                                        all_phase_histo_timecourse=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes)*no_bins,par_out(LFPNo).PAC(1).no_trials,length(t_pac));
                                    else
                                        ...
                                        all_phase_histo_timecourse=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes)*no_bins,par_out(LFPNo).PAC(1).no_trials+no_trialsPAC,length(t_pac));
                        ...
                        if (sum(handles.drgbchoices.which_discriminant==7)>0)||(sum(handles.drgbchoices.which_discriminant==8)>0)||...
                            ...
                            for LFPNo=1:length(handles.drgbchoices.phase_electrodes)
                                ...
                                if LFPNo==1
                                    if no_trials==0
                                        all_log_P_timecoursePACpeak=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PAC(1).meanPeakPower),length(t));
                                        all_log_P_timecoursePACtrough=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PAC(1).meanTroughPower),length(t));
                                    else
                                        %Peak
                                        ...
                                        all_log_P_timecoursePACpeak=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PAC(1).meanPeakPower)+no_trials,length(t));
                                        ...
                                        szt=size(this_all_log_P_timecoursePAC,4);
                                        all_log_P_timecoursePACtrough=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PAC(1).meanTroughPower)+no_trials,length(t));
                        ...
                        if (sum(handles.drgbchoices.which_discriminant==10)>0)||(sum(handles.drgbchoices.which_discriminant==11)>0)||...
                            ...
                            trials_match=1;
                            minLFP=1;
                            for LFPNo=2:length(handles.drgbchoices.phase_electrodes)
...
%                                             par_out(LFPNo).PACwave(PACii).meanPower=par_out(LFPrep).PACwave(PACii).meanPower;
                            ...
                            for LFPNo=1:length(handles.drgbchoices.phase_electrodes)
                                ...
                                %                             this_peakLFPNo=handles.drgbchoices.phase_electrodes(LFPNo);
                                if LFPNo>1
                                ...
                                if LFPNo==1
                                    if no_trialsPACwave==0
                                        all_log_P_timecoursePACwavepeak=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PACwave(1).meanPeakPower),length(t));
                                        all_log_P_timecoursePACwavetrough=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PACwave(1).meanTroughPower),length(t));
                                    else
                                        %Peak
                                        ...
                                        all_log_P_timecoursePACwavepeak=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PACwave(1).meanPeakPower)+no_trialsPACwave,length(t));
                                        ...
                                        szt=size(this_all_log_P_timecoursePACwave,4);
                                        all_log_P_timecoursePACwavetrough=zeros(length(handles.drgbchoices.PACburstLowF),length(handles.drgbchoices.phase_electrodes),length(par_out(LFPNo).PACwave(1).meanTroughPower)+no_trialsPACwave,length(t));
                            ...
                            for percent_correct_ii=1:length(handles.drgbchoices.per_lab)
                                ...
                                if N>=20
                                    ...
                                    if sum(handles.drgbchoices.which_discriminant==1)>0
                                        ...
                                        num_traces=length(handles.drgbchoices.phase_electrodes); %Number of electrodes
                                        ...
                                        these_all_log_P_timecourse=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(t));
                                        ...
                                        parfor time_point=1:length(t)
                                            ...
                                            per_input=zeros(length(handles.drgbchoices.phase_electrodes),N);
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        parfor time_point=1:length(t)
                                            ...
                                            measurements=zeros(N,length(handles.drgbchoices.phase_electrodes));
                                            ...
                                            for ii=1:N
                                                ...
                                                shuffled_measurements=zeros(N,length(handles.drgbchoices.phase_electrodes));
                                    ...
                                    if sum(handles.drgbchoices.which_discriminant==6)>0
                                        ...
                                        these_all_log_P_timecourse=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(subt));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        par_out=[];
                                        max_combs=25;
                                        for no_elect=1:length(handles.drgbchoices.phase_electrodes)
                                        ...
                                        %parfor no_elect=1:length(handles.drgbchoices.phase_electrodes)
                                        parfor no_elect=1:length(handles.drgbchoices.phase_electrodes)
                                            
                                            par_out(no_elect).no_elect=length(handles.drgbchoices.phase_electrodes);
                                            par_out(no_elect).no_timepoints=length(subt);
                                            %Choose electrode combinations
                                            %(max =25)
                                            
                                            elect_combs=nchoosek(1:length(handles.drgbchoices.phase_electrodes),no_elect);
                                            ...
                                            %tetrode
                                            if no_elect==4
                                                for tetNo=1:length(handles.drgbchoices.phase_electrodes)/4
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        for time_point=1:length(t)
                                            par_t_out(time_point).principal_components=zeros(N,length(handles.drgbchoices.phase_electrodes));
                                        end
                                        ...
                                        principal_components=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        PC_variance=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
                                        for time_point=1:length(t)
                                        ...
                                        if bwii==4
                                            ...
                                            these_pcs=zeros(N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).discriminant_calculated=1;
                                        handles_out.discriminant_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).bwii(bwii).principal_components=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).bwii(bwii).PC_variance=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
                            ...
                            for percent_correct_ii=1:length(handles.drgbchoices.per_lab)
                                ...
                                if N>=20
                                    ...
                                    if (sum(handles.drgbchoices.which_discriminant==7)>0)
                                        ...
                                        these_all_log_P_timecoursePAC=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(t));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        handles_out.discriminant_PACpower_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).principal_components_peak=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_PACpower_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).PC_variance_peak=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        %                                         handles_out.discriminant_PACpower_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).discriminant_calculated=1;
                                        handles_out.discriminant_PACpower_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).principal_components_trough=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_PACpower_per_mouse(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).PC_variance_trough=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
                                    ...
                                    if sum(handles.drgbchoices.which_discriminant==9)>0
                                        ...
                                        these_all_log_P_timecoursePAC=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(subt));
                            ...
                            for percent_correct_ii=1:length(handles.drgbchoices.per_lab)
                                ...
                                if N>=20
                                    ...
                                    if (sum(handles.drgbchoices.which_discriminant==10)>0)
                                        ...
                                        these_all_log_P_timecoursePACwave=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(t));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).principal_components_peak=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).PC_variance_peak=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        %                                         handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).percent_correct(percent_correct_ii).discriminant_calculated=1;
                                        handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).principal_components_trough=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                        ...
                                        handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).percent_correct(percent_correct_ii).PACii(PACii).PC_variance_trough=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
                                    ...
                                    if sum(handles.drgbchoices.which_discriminant==12)>0
                                        ...
                                        these_all_log_P_timecoursePACwave=zeros(length(handles.drgbchoices.phase_electrodes),sum(these_per_corr),length(subt));
                            ...
                            for percent_correct_ii=1:length(handles.drgbchoices.per_lab)
                                ...
                                if N>=20
                                    ...
                                    if sum(handles.drgbchoices.which_discriminant==4)>0
                                        ...
                                        these_all_phase_histo_timecourse=zeros(length(handles.drgbchoices.phase_electrodes)*no_bins,sum(these_per_corr),length(t_pac));
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        parfor time_point=1:length(t_pac)
                                            ...
                                            %LFP power per trial per electrode
                                            measurements=zeros(N,length(handles.drgbchoices.phase_electrodes)*no_bins);
                                            ...
                                            for ii=1:N
                                                ...
                                                %Do LDA with shuffled trials
                                                shuffled_measurements=zeros(N,length(handles.drgbchoices.phase_electrodes)*no_bins);
                                                shuffled_measurements(:,:)=measurements(randperm(N),:);
...
%                                             kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                        ...
                                        for time_point=1:length(t_pac)
                                            par_t_out(time_point).principal_componentsPAC=zeros(N,length(handles.drgbchoices.phase_electrodes)*no_bins);
                                        end
                    ...
                    for groupNo=1:2
                        ...
                        if N>=20
                            ...
                            if (sum(handles.drgbchoices.which_discriminant==13)>0)
                                ...
                                these_all_log_P_timecoursePACwave=zeros(length(handles.drgbchoices.phase_electrodes),sum(trials_for_this_group),length(t));
...
%                                     kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                                ...
                                handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis_ii).PACii(PACii).principal_components_peak=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                ...
                                handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis_ii).PACii(PACii).PC_variance_peak=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
                                ...
                                %                                         handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis_ii).discriminant_calculated=1;
                                handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis_ii).PACii(PACii).principal_components_trough=zeros(length(t),N,length(handles.drgbchoices.phase_electrodes));
                                ...
                                handles_out.discriminant_PACwavepower(mouseNo).group(groupNo).which_analysis(which_analysis_ii).PACii(PACii).PC_variance_trough=zeros(length(t),length(handles.drgbchoices.phase_electrodes));
...
%                                 kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                            ...
                            these_all_test_log_P_timecoursePACwave=zeros(length(handles.drgbchoices.phase_electrodes),sum(trials_for_this_test_group),length(t));
...
%                                 kk=find(handles.drgbchoices.evTypeNos==handles.drgbchoices.events_to_discriminate(ii));
                            ...
                            parfor time_point=1:length(t)
                                ...
                                test_measurements=zeros(N,length(handles.drgbchoices.phase_electrodes));
