function handles_pars=drgLFPBatchAnalPars_spm_daniel_fig2g
...
% handles_pars.files=[1:22];     %EAPA Forward ethyl acetate 
% handles_pars.output_suffix='_EAPA.mat';


handles_pars.files=[53:80];     %APEB Forward aceto both control and exp, clear increase for MI for
